...
<div class="mb-3 visually-hidden">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="id" value="<%=produit.getId()%>" required="required">
    <div id="emailHelp" class="form-text">We'll never share your Designation with anyone else.</div>
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Designation</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="Designation" value="<%=produit.getDesignation()%>" required="required">
    <div id="emailHelp" class="form-text">We'll never share your Designation with anyone else.</div>
  </div>
  <div class="mb-3">
